...
func (c *Client) SendMessage(ctx context.Context, token, text, contextID string) (*SendResult, error) {
	return c.SendMessageWithID(ctx, token, text, contextID, "")
}

// SendMessageWithID is SendMessage with a caller-provided message ID. This
// lets durable audit records use the exact identifier placed on the wire.
// An empty messageID is generated by the client.
func (c *Client) SendMessageWithID(ctx context.Context, token, text, contextID, messageID string) (*SendResult, error) {
